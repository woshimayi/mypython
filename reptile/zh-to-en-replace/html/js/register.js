$(function () {
	...
	var register_sm = new StateMachine({
		...
		data:{
			progressInfo:{
				"20%"       :  "正在注册 OLT",
				"30%"       :  "正在获取管理 IP",
				"40%"       :  "已获得管理 IP，正在连接省级数字家庭管理平台",
				"50%"       :  "等待省级数字家庭管理平台下发业务数据",
				"60%"       :  "省级数字家庭管理平台正在下发业务数据，请勿断电或拔光纤",
				"61%"       :  "省级数字家庭管理平台正在下发 ",
				"62%"       :  " 业务数据，请勿断电或拔光纤",
				"100%"       :  "省级数字家庭管理平台业务数据下发成功",
				"101%"      :  "省级数字家庭管理平台业务数据下发成功，共下发了 ",
				"102%"      :  " 个业务",
				"regMsgSuccess"  :  "已注册成功，无需再注册"
			},
			failInfo:{
				"errMsg20" : "在 OLT 上注册失败，请检查光信号灯是否处于熄灭状态、loid/password 是否正确",
				"errMsg20_l" : "在 OLT 上注册失败，请检查光信号灯是否处于熄灭状态、loid 是否正确",
				"errMsg20_p" : "在 OLT 上注册失败，请检查光信号灯是否处于熄灭状态、password 是否正确",
				"errMsg30" : "省级数字家庭管理平台的通道不通，请联系客户经理或拨打10086”或者没有获取到ip地址",
				"errMsg40" : "到省级数字家庭管理平台的通道不通，请联系客户经理或拨打 10086",
				"errMsg401" : "在省级数字家庭管理平台上注册失败，正在重试",
				"errMsg402" : "在省级数字家庭管理平台上注册失败，请联系客户经理或拨打 10086",
				"errMsg60" : "省级数字家庭管理平台下发业务异常，请联系客户经理或拨打 10086",
				"errMsg40_stu1" : "错误代码1，Password不存在",
				"errMsg40_stu4" : "错误代码4，超时",
				"errMsg40_stu5" : "错误代码5，已注册过且无新工单要执行",
			}
		},
		methods:{
			//AfterTransition
	...
	function selectOnuLoidPwd(){
		...
		switch(g_regionCfg.onuAuthType){
			...
			case "Loid":
				...
				$("#Password").attr("placeholder", "请输入LOID");
	...
	function caculatePwdLength()
	{
		...
		if (len < 11) {
			...
			$("#pwdLengthInfo").html("，请核对"+g_regionCfg.onuAuthType+"长度是否正确!");
		}
	}
