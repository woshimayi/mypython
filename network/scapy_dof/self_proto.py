...
def send_single_packet(interface="eth0", target_mac="00:11:22:33:44:55",
                       msg_type=0x0001, seq_num=1, src_ip="192.168.1.100",
                       dst_ip="192.168.1.1"):
    """
    发送单个数据包
    ...
    try:
        ...
        if choice == 'y':
            ...
            while True:
                ...
                msg_type = 1
                seq_num = 123
                # src_ip = input("输入源IP (默认192.168.1.100): ") or "192.168.1.100"
                # dst_ip = input("输入目的IP (默认192.168.1.1): ") or "192.168.1.1"
